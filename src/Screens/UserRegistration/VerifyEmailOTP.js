...
const VerifyOTP = () => {
  ...
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title>{`Verify Your account with Email OTP | Rozgaar India `}</title>
        <meta
          name="description"
          content={`Verify your account with OTP sent to your email at www.rozgaarindia.com`}
       
       />
           <link rel="canonical" href="https://www.rozgaarindia.com/verifyEmailOTP" /> 
      </Helmet>
      <React.Suspense
        fallback={
